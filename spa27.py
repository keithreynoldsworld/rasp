...
arduino_port = '/dev/ttyACM0'  # Replace with your Arduino port
    ...
    while True:
        ...
        with sd.InputStream(samplerate=sample_rate, channels=1, dtype='int16', callback=audio_callback):
            with keyboard.Listener(on_press=on_press, on_release=on_release) as listener:
                while not stop_listener:  # Run listener until spacebar is released
                    listener.join(0.1)

        transcribe_and_respond()  # Process the recording
